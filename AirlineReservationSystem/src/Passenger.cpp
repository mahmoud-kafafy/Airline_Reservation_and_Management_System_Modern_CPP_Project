...
void Passenger::displayMenu() {
    ...
    do {
        ...
        cout << "5. Confirm Cash Payment" << endl; // Confirm payment if cash was used
        cout << "6. Logout" << endl;
        cout << "Enter choice: ";
        cin >> choice; 
        ...
        switch (choice) {
            ...
            case 5: confirmCashPayment(); break; // Call to confirm cash payment
...
void Passenger::bookFlight() {
    ...
    if (!selectedFlight) {
     ...
     vector<shared_ptr<Reservation>> reservations = Reservation::loadReservations();
    ...
    string reservationID =  generateRandomReservationID();  // Generate a random reservation ID
    ...
    reservations = Reservation::loadReservations(); // Reload reservations after adding a new one
}
 ...
 */
void Passenger::viewAllReservations() {
 ...
 */
void Passenger::viewSpecificReservations() {
    if (reservations.empty()) {
        cout << "\nNo reservations found.\n"; // If no reservations exist
        return;
    }
...
void Passenger::confirmCashPayment() {
    string reservationID;
